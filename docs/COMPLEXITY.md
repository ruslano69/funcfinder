...
## ⚠️ ВАЖНО: Различайте типы вложенности!

**Не вся вложенность одинакова:**

- 🔴 **Вложенные ЦИКЛЫ** (for/while внутри for/while) → **КРИТИЧНО для производительности** (O(n²), O(n³))
- ⚠️ **Вложенные IF** → просто когнитивная сложность (читаемость)

**См. [PERFORMANCE.md](PERFORMANCE.md) для детального анализа производительности и стратегий оптимизации.**
